...
def load_optc_dist(workers, start=0, end=635015, delta=8640, is_test=False, ew_fn=std_edge_w):
    ...
    if workers <= 1:
        return load_partial_optc(start, end, delta, is_test, ew_fn)
...
if __name__ == '__main__':
    data = load_optc_dist(2, start=0, end=ALL, delta=1800)
    print(data)
